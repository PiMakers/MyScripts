...
playList = '/storage/.kodi/userdata/playlists/video/StefanLengyel.m3u'
...
def setUpGPIO():
  ...
  """
  GPIO.add_event_detect(BUTTON_PIN , GPIO.RISING, callback=my_callback)
...
player.play('/storage/.kodi/userdata/playlists/video/StefanLengyel.m3u')
player.pause()
